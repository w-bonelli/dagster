...
class DagsterInstance:
    ...
    def stop_schedule_and_update_storage_state(self, schedule_id):
        return self._scheduler.stop_schedule_and_update_storage_state(self, schedule_id)

    def stop_schedule_and_delete_from_storage(self, schedule_id):
        return self._scheduler.stop_schedule_and_delete_from_storage(self, schedule_id)

    def running_schedule_count(self, schedule_id):
        return self._scheduler.running_schedule_count(schedule_id)
    ...
    def scheduler_debug_info(self):
        ...
        for schedule_state in self.all_stored_schedule_state():
            ...
            if self.running_schedule_count(schedule_state.schedule_id) > 1:
                errors.append(
            ...
            schedule_info = {
                schedule_state.name: {
                    ...
                    "repository_id": schedule_state.repository_id,
                }
            }
    ...
    def get_schedule_ticks(self, schedule_id):
        return self._schedule_storage.get_schedule_ticks(schedule_id)

    def get_schedule_tick_stats(self, schedule_id):
        return self._schedule_storage.get_schedule_tick_stats(schedule_id)

    def all_stored_schedule_state(self, repository_id=None):
        return self._schedule_storage.all_stored_schedule_state(repository_id)

    def get_schedule_state(self, schedule_id):
        return self._schedule_storage.get_schedule_state(schedule_id)
    ...
    def delete_schedule_state(self, schedule_id):
        return self._schedule_storage.delete_schedule_state(schedule_id)
    ...
    def logs_path_for_schedule(self, schedule_id):
        return self._scheduler.get_logs_path(self, schedule_id)
