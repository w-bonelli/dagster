...
class ScheduleStorage(six.with_metaclass(abc.ABCMeta)):
    ...
    def all_stored_schedule_state(self, repository_id=None):
        ...
        Args:
            repository_id (Optional[str]): The ExternalRepository target id to scope results to
        '''
    ...
    def get_schedule_state(self, schedule_id):
        ...
        Args:
            schedule_id (str): The unique schedule identifier
        '''
    ...
    def delete_schedule_state(self, schedule_id):
        ...
        Args:
            schedule_id (str): The id of the ExternalSchedule target to delete
        '''
    ...
    def get_schedule_ticks(self, schedule_id):
        ...
        Args:
            schedule_id (str): The id of the ExternalSchedule target
        '''
